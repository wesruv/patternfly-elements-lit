...
import { PfeReadtime } from "../dist/pfe-readtime.js";
...
describe("<pfe-readtime>", () => {
  it("should upgrade", async () => {
    const el = await createFixture(element);
    expect(el).to.be.an.instanceOf(customElements.get(PfeReadtime.tag), "pfe-readtime should be an instance of PfeReadtime");
  });
  ...
  it("should calculate readtime based on given wpm", async () => {
    const el = await createFixture(element);
    // pfeReadtime.setAttribute("wpm", "100");
    el.setAttribute("wpm", "100");
    expect(el.getAttribute("readtime")).to.equal("5");
  });
});